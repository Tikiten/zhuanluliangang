...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='D:/Spyder/zhuanluliangang_online/data',
        type=str,
        help='Root directory path of data')
    parser.add_argument(
        '--video_path',
        default='demo_jpg_crop',
        type=str,
    ...
    parser.add_argument(
        '--result_path',
        default='D:/Spyder/zhuanluliangang_online/results',
        type=str,
    ...
    parser.add_argument(
        ...
        default='own',
        type=str,
        help='Used dataset (activitynet | kinetics | ucf101 | hmdb51|own)')
    parser.add_argument(
        '--n_classes',
        default=4,
        type=int,
        help=
        'Number of classes (activitynet: 200, kinetics: 400, ucf101: 101, hmdb51: 51|own:3)'
    )
    parser.add_argument(
        '--n_finetune_classes',
        default=4,
    ...
    parser.add_argument(
        '--resume_path',
        default='D:/Spyder/zhuanluliangang_online/results/save_1100.pth',
        type=str,
